...
<body>
	...
	<nav class="nav navbar-nav bg-dark" id="sidenav">
		...
		<a class="nav-link text-white p-3" href="#">候位者驗證</a>
			<form class="needs-validation" novalidate METHOD="post" ACTION="RES_Transaction_List.do" name="form1">
...
<c:forEach var="rtlVO" items="${rtlSvc.getOneVendor('V000001')}">

  
  
  
  <a href="#" class="list-group-item list-group-item-action">${rtlVO.trst_no}</a>
